...
3. ✅ Hazler Node
    ...
    - ✅ Position Y
    -
4. ✅ Hazler Workflow Execution Log
    - ✅ Status
    - Execution Time
    - ✅ Hazler Workflow
...
-   Executive on click trigger?
-   AND/OR 1 trigger node (Scheduled Job / CRON)
-   1 action node (HTTP Request)
-   Ability to add nodes (dialog?)
